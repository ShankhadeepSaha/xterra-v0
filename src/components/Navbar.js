  ...
  return (
    <nav className="flex items-center justify-between bg-white px-8 py-2">
      ...
      <div className="flex align-middle space-x-8">
        <a href="#sports" className="text-gray-800 text-sm font-['Switzer'] hover:text-gray-900">SPORTS</a>
        <a href="#gym" className="text-gray-800 text-sm hover:text-gray-900">GYM</a>
        <a href="#about" className="text-gray-800 text-sm hover:text-gray-900">ABOUT US</a>
        <a href="#contact" className="text-gray-800 text-sm hover:text-gray-900">CONTACT US</a>
      </div>
